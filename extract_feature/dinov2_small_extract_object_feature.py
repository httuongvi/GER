...
# --- 1. CẤU HÌNH ---
KAGGLE_PATCH_DATASET = "fullgroupemow-object-cropped" 
INPUT_DIR = f"/kaggle/input/{KAGGLE_PATCH_DATASET}/groupemow-full-object-patches"

# Output folder mới
OUTPUT_FEATURE_DIR = "/kaggle/working/Object_Features_GroupEmoW_dinov2_vits14"
...
class ObjectExtractionDataset(Dataset):
...
extract_dataset = ObjectExtractionDataset(root_dir=INPUT_DIR, transform=extraction_transform)
...
print("\n--- TRÍCH XUẤT OBJECT (dinov2_vits14) HOÀN TẤT ---")