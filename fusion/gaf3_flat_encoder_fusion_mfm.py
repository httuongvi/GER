...
# Dataset paths
FACE_FEATURE_DIR       = "/kaggle/input/datasets/zi123456789/facial-features-gaf3-dinov2-vits14/facial_features_gaf3_dinov2_vits14"
OBJECT_FEATURE_DIR     = "/kaggle/input/datasets/zi123456789/object-features-gaf3-dinov2-vits14/Object_Features_Gaf3_dinov2_vits14"
SCENE_FEATURE_DIR      = "/kaggle/input/datasets/zi123456789/scene-features-gaf3-swin-tiny/Scene_Features_Gaf3_swin_tiny"

OUTPUT_DIR = "/kaggle/working"
MODEL_PATH = os.path.join(OUTPUT_DIR, "vilt_ablation_pure_vision_baseline_gaf3.pth")
...
def plot_confusion_matrix(labels_true, preds, save_dir):
    ...
    path = os.path.join(save_dir, "confusion_matrix_gaf3.png")
    plt.tight_layout()
...
def plot_training_history(train_losses, val_losses, train_accs, val_accs, save_dir):
    ...
    path = os.path.join(save_dir, "training_history_gaf3.png")
    plt.tight_layout()
    plt.savefig(path, dpi=150)
    plt.close()
...
# ==========================================
# 7. MAIN (GAF3 — 10 RUNS PROTOCOL)
# ==========================================

if __name__ == "__main__":
    print("\n" + "=" * 65)
    print("  ViLT Ablation — Pure Vision Baseline (MSE MFM, No Text, No SAM)")
    print(f"  Dataset: GAF3 | Protocol: {NUM_RUNS} runs, best val acc → final eval on val")
    print("=" * 65)
